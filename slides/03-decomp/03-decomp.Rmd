...
Since the $RCI$ is a function of a health variable $(y_{i})$ and a socioeconomic rank variable $(R_{i})$, i.e.
...
---
.footnote[McKinnon et al. (2011)]
```{r, echo=F, out.height="90%", out.width="90%"}
knitr::include_graphics(here("images", "mckinnon-cervical.png"))
```
