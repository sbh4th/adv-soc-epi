...
[**I. "What-If" Questions and Counterfactuals**]{.orange}

[**II. Causal Parameters**]{.orange}

[**III. Causal Assumptions**]{.orange}
...
::::: columns
:::: {.column width="50%"}
<span style="color:blue; font-size:3em">●●●●</span>
...
::::{.right-column}
[In 1747 Lind tested several scurvy treatments on crew members of the British navy and discovered that lemons and oranges were most effective.]{style="font-size: 0.85em"}
...
tt(po_disp, width = 0.6) |>
  ...
  setNames(c("ID", "$d_{i}$", "$y_{i}^{1}$", "$y_{i}^{0}$")) |>
...
::::: columns
:::: {.column width="50%"}
<span style="color:blue; font-size:2.5em">●●●●</span>
...
tt(po, width = 0.7) |>
  ...
  group_tt(j = list(" " = 1, "Treatment" = 2,
                    "Potential Outcomes" = 3:4, "Effect" = 5)) |>
  setNames(c("ID", "$d_{i}$", "$y_{i}^{1}$", "$y_{i}^{0}$", "$\\delta_{i}$")) |>
  style_tt(j = 1:5, align = "c") |>
  style_tt(fontsize = 0.9)
```
::::

## Individual causal effects (observed)
...
<span style="color:gray; font-size:2em">●●●●●●●●</span>
...
- Unlike their individual-level analogues, we can use our observed data to estimate $E(y_{i})$ and calculate a "naïve" estimate of the ATE]{.gray}
::::
:::: {.column width="50%"}
```{r}
...
<div style="text-align:center">
<span style="color:blue; font-size:2em">●●●●</span><span style="color:red; font-size:2em">●●●●</span>
...
## Causation vs. association under randomization
...
<span style="color:blue; font-size:2em">●</span><span style="color:red; font-size:2em">●</span><span style="color:blue; font-size:2em">●</span><span style="color:red; font-size:2em">●</span><span style="color:blue; font-size:2em">●</span><span style="color:red; font-size:2em">●</span><span style="color:blue; font-size:2em">●</span><span style="color:red; font-size:2em">●</span>
</div>
...
| ------------- |:-------------:| -----:|
| Treatment group $(D=1)$ | 10 | [6]{.blue} |
| Control group $(D=0)$  | [8]{.blue} | 5 |
...
Causal inference requires that a treatment is defined unambiguously, which is a general concern in social epidemiology
